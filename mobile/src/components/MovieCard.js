...
export default function MovieCard({ movie, onPress, horizontal, priority = 'normal' }) {
  ...
  return (
    <TouchableOpacity style={[styles.card, { width: W }]} onPress={onPress} activeOpacity={0.8}>
      <CachedImage
        source={movie.poster_url || 'https://via.placeholder.com/300x450?text=Movie'}
      ...
      <View style={styles.info}>
        ...
        <View style={styles.meta}>
          ...
          <Text style={styles.metaText}>{movie.duration_min || movie.duration_minutes}′</Text>
        </View>
      </View>
    </TouchableOpacity>
  );
